...
var MapControls = /*#__PURE__*/function (_OrbitControls) {
  ...
  function MapControls(object, domElement) {
    ...
    _this = _super.call(this, object, domElement);
    _this.screenSpacePanning = false; // pan orthogonal to world-space direction camera.up

    _this.mouseButtons.LEFT = MOUSE.PAN;
    _this.mouseButtons.RIGHT = MOUSE.ROTATE;
    _this.touches.ONE = TOUCH.PAN;
    _this.touches.TWO = TOUCH.DOLLY_ROTATE;
    return _this;
  }
